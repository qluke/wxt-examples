...
Export time: 2025/8/1 18:23:08

Source directory: `wxt-i18n`
...
### .wxt\i18n\structure.d.ts

```typescript
// .wxt\i18n\structure.d.ts
export type GeneratedI18nStructure = {
  "extension.name": { substitutions: 0, plural: false };
  "extension.description": { substitutions: 0, plural: false };
  "popup.title": { substitutions: 0, plural: false };
  "popup.hello": { substitutions: 1, plural: false };
